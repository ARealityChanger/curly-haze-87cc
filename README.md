...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-haze-87cc)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly-haze-87cc
```

A live public deployment of this template is available at [https://curly-haze-87cc.templates.workers.dev](https://curly-haze-87cc.templates.workers.dev)
